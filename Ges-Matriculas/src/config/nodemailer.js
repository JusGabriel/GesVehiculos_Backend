  ...
  return `
    <div style="max-width:600px; margin:0 auto; background:#ffffff; border:1px solid #e0e0e0; border-radius:12px; overflow:hidden; font-family: 'Segoe UI', sans-serif; color:#333;">
        ...
        <div style="background-color:#f9f9f9;">
            <img src="https://raw.githubusercontent.com/JusGabriel/Frontend/main/frontend-vet/src/assets/logo.jpg" alt="Logo GesVehiculos" style="width:100%; max-height:200px; object-fit:cover;">
        </div>
        ...
        <div style="background-color:#f2f2f2; padding:18px; text-align:center; font-size:13px; color:#777;">
            <p style="margin:0;">© 2025 GesVehiculos · Todos los derechos reservados</p>
...
const sendMailToRegister = (userMail, token) => {
  ...
  const htmlContent = emailTemplate(
    "Confirma tu Cuenta",
    `Gracias por registrarte en <strong>GesVehiculos</strong>. Para completar tu registro, haz clic en el siguiente botón:`,
    "Confirmar Cuenta",
    confirmationUrl
  );

  let mailOptions = {
    from: '"GesVehiculos" <admin@gesVehiculos.com>',
    to: userMail,
    subject: "GesVehiculos - Confirma tu Cuenta",
    html: htmlContent
  };
...
const sendMailToRecoveryPassword = (userMail, token) => {
  ...
  const htmlContent = emailTemplate(
    ...
    `Recibimos una solicitud para restablecer tu contraseña en <strong>GesVehiculos</strong>. Si tú la solicitaste, haz clic en el botón para continuar.`,
  ...
  let mailOptions = {
    from: '"GesVehiculos" <admin@gesVehiculos.com>',
    to: userMail,
    subject: "GesVehiculos - Reestablece tu Contraseña",
    html: htmlContent
  };
